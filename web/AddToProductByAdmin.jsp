    ...
    <body>
        ...
        <div class="container">
            <form action="CreateProductController" method="post">
                ...
                <div class="form-group col-md-12">
                    <input type="text" name="linkimage" class="form-control" required="required" placeholder="Image">
                </div>
                <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                    <input type="number" name="Category" class="form-control" required="required" placeholder="Category">
                </div>
