...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <jsp:useBean id="a" class="DAO.DAO" scope="request"/>
                ...
                <tbody>
                    ...
                    <c:forEach items="${a.allAccount}" var="o">
                          <tr>
                            ...
                            <td>${o.address}</td>
                            <td>
                                <a href="DeleteAccountOfCustomer?id=${o.userid}"
                                   onclick="return confirm('Are you sure want to DELETE?')"><button type="button" class="btn btn-danger">Delete</button></a>
                            </td>
